...
// extrude the surface to make a domain
// supposedly this makes all the entities I need, getting a hold of them might be a different story
...
Physical Surface("inflow") = surface_vector[2]; // inlet
Physical Surface("outflow") = surface_vector[5]; // outlet
Physical Surface('wall') = {
surface_vector[0], // new extruded surface, the fore wall
surface_vector[3], // top wall
surface_vector[4], // extension to end
surface_vector[6], // bottom expansion
surface_vector[7], // post-cavity flat
surface_vector[8], // cavity rear (slant)
surface_vector[9], // cavity bottom
surface_vector[10], // cavity front
surface_vector[11], // isolator to cavity
surface_vector[12], // bottom wall
1 // from original surface now the aft wall
};
